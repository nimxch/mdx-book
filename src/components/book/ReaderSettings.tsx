...
export function ReaderSettings({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) {
  ...
  return (
    <>
      ...
      <Card className="absolute top-full left-0 mt-2 w-80 z-50 shadow-xl animate-in slide-in-from-top-2 duration-200 border-border bg-popover text-popover-foreground">
